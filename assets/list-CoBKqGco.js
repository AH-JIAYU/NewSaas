...
import{k as w,d as y,r as i,a as r,al as b,am as C,i as p,o as V,b as N,f as t,w as a,l as m,F as f,g as $,p as z,aK as k,aL as P,_ as B}from"./index-CGMecxe4.js";const E={list:o=>w.post("other-ip/get/getIpInfo",o)},S=o=>(k("data-v-c7b91794"),o=o(),P(),o),D={class:"flex-c"},F=S(()=>f("div",{class:"i-material-symbols-light:not-started-outline-rounded h-1.5em w-1.5em"},null,-1)),U=y({name:"OtherFunctionsQueryIpIndex",__name:"list",setup(o){const d=i(!1),l=i([]),c=i("");async function v(){d.value=!0;const _=l.value.split(`
