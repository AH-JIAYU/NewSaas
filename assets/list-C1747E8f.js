...
import{k as b,d as N,r as g,a as m,q as v,s as y,i as h,o as I,b as P,f as t,w as n,A as x,y as w,e as $,g as z,E as k,an as E,aH as B,aI as q,L as S}from"./index-DmuEaMIU.js";const D={list:s=>b.post("other-ip/getIpInfo",s)},M=s=>(B("data-v-846f1f2b"),s=s(),q(),s),U={class:"flex-c"},j=M(()=>w("div",{class:"i-material-symbols-light:not-started-outline-rounded h-1.5em w-1.5em"},null,-1)),A=N({name:"queryIP",__name:"list",setup(s){const C=g(!1),a=g([]),r=g("");async function V(){try{if(a.value&&a.value.length===0)return k.warning({message:"请至少输入一个IP",center:!0});const c=a.value.split(`
