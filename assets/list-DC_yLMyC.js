...
import{k as I,d as w,r as u,a as d,an as C,ak as N,i as p,o as V,b,f as t,w as n,C as _,A as m,g as $,E as z,aj as k,aH as E,aI as P,N as B}from"./index-ZCXpFWW9.js";const S={list:s=>I.post("other-ip/getIpInfo",s)},j=s=>(E("data-v-e3ccc4d1"),s=s(),P(),s),D={class:"flex-c"},M=j(()=>m("div",{class:"i-material-symbols-light:not-started-outline-rounded h-1.5em w-1.5em"},null,-1)),U=w({name:"OtherFunctionsQueryIpIndex",__name:"list",setup(s){const f=u(!1),a=u([]),c=u("");async function g(){try{if(a.value&&a.value.length===0)return z.warning({message:"请至少输入一个IP",center:!0});const r=a.value.split(`
