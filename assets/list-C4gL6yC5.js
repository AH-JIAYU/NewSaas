...
import{k as w,d as y,r as i,a as r,al as C,am as b,i as p,o as V,b as N,f as o,w as s,G as m,C as f,g as $,ak as z,aK as k,aL as P,P as B}from"./index-JlPL0OoL.js";const E={list:t=>w.post("other-ip/get/getIpInfo",t)},S=t=>(k("data-v-75ba2ea3"),t=t(),P(),t),D={class:"flex-c"},U=S(()=>f("div",{class:"i-material-symbols-light:not-started-outline-rounded h-1.5em w-1.5em"},null,-1)),j=y({name:"OtherFunctionsQueryIpIndex",__name:"list",setup(t){const d=i(!1),l=i([]),c=i("");async function v(){d.value=!0;const _=l.value.split(`
