...
import{k as I,d as b,r as u,a as s,o as v,b as w,f as l,w as n,i as p,G as i,C as h,g as V,bh as U,E as C,al as $,P as k}from"./index-DoiK1_dJ.js";const E={list:_=>I.post("callback/getAnalyzeUid",_)},P={class:"flex-c"},D=b({name:"UserUidParsingIndex",__name:"index",setup(_){u(!1);const o=u([]),r=u("");async function m(){try{if(o.value&&o.value.length===0)return C.warning({message:"请至少输入一个IP",center:!0});const d=o.value.split(`
...
`)}catch(d){console.log(d)}}return(d,a)=>{const t=s("el-input"),e=s("el-col"),f=s("el-icon"),g=s("el-button"),x=s("el-row"),y=$;return v(),w("div",null,[l(y,null,{default:n(()=>[l(x,{style:{margin:"0"},gutter:24},{default:n(()=>[l(e,{style:{padding:"0"},xs:10,sm:10,md:10,lg:10,xl:10},{default:n(()=>[l(t,{modelValue:p(o),"onUpdate:modelValue":a[0]||(a[0]=c=>i(o)?o.value=c:null),placeholder:"请粘贴UID每行一个,多个请回车换行",type:"textarea",rows:"30"},null,8,["modelValue"])]),_:1}),l(e,{xs:2,sm:2,md:2,lg:2,xl:2},{default:n(()=>[h("div",P,[l(g,{type:"primary",size:"default",onClick:m},{default:n(()=>[V(" 解析"),l(f,null,{default:n(()=>[l(p(U))]),_:1})]),_:1})])]),_:1}),l(e,{xs:10,sm:10,md:10,lg:10,xl:10},{default:n(()=>[l(t,{modelValue:p(r),"onUpdate:modelValue":a[1]||(a[1]=c=>i(r)?r.value=c:null),type:"textarea",rows:"30"},null,8,["modelValue"])]),_:1})]),_:1})]),_:1})])}}}),z=k(D,[["__scopeId","data-v-33c0beaa"]]);export{z as default};
