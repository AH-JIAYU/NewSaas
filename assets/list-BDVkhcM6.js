...
import{k as I,d as w,r as f,a as m,q as C,s as V,i as g,o as N,b as $,f as t,w as l,A as v,y as h,g as b,E as z,ap as P,aH as E,aI as k,L as B}from"./index-Ds171FZW.js";const S={list:s=>I.post("other-ip/getIpInfo",s)},q=s=>(E("data-v-0911c69f"),s=s(),k(),s),D={class:"flex-c"},M=q(()=>h("div",{class:"i-material-symbols-light:not-started-outline-rounded h-1.5em w-1.5em"},null,-1)),U=w({name:"queryIP",__name:"list",setup(s){const y=f(!1),o=f([]),c=f("");async function x(){try{if(o.value&&o.value.length===0)return z.warning({message:"请至少输入一个IP",center:!0});const i=o.value.split(`
