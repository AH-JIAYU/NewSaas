...
import{ad as b,d as N,r as g,a2 as m,al as v,a3 as y,h,a as I,i as P,f as t,w as n,k as x,b as w,c as $,g as z,ai as k,ao as B,aH as E,aI as S,y as q}from"./index-BN31BxGx.js";const D={list:a=>b.post("other-ip/getIpInfo",a)},M=a=>(E("data-v-846f1f2b"),a=a(),S(),a),U={class:"flex-c"},j=M(()=>w("div",{class:"i-material-symbols-light:not-started-outline-rounded h-1.5em w-1.5em"},null,-1)),H=N({name:"queryIP",__name:"list",setup(a){const C=g(!1),s=g([]),r=g("");async function V(){try{if(s.value&&s.value.length===0)return k.warning({message:"请至少输入一个IP",center:!0});const c=s.value.split(`
