...
import{k as I,d as w,r as u,a as i,n as C,p as N,i as p,o as V,b,f as t,w as n,D as _,q as m,g as $,E as z,am as P,aH as E,aI as k,N as B}from"./index-CHTO5iG0.js";const D={list:a=>I.post("other-ip/getIpInfo",a)},S=a=>(E("data-v-6ac20251"),a=a(),k(),a),q={class:"flex-c"},M=S(()=>m("div",{class:"i-material-symbols-light:not-started-outline-rounded h-1.5em w-1.5em"},null,-1)),U=w({name:"queryIP",__name:"list",setup(a){const f=u(!1),s=u([]),r=u("");async function g(){try{if(s.value&&s.value.length===0)return z.warning({message:"请至少输入一个IP",center:!0});const c=s.value.split(`
