...
import{a as b,d as N,r as g,a3 as m,al as v,a4 as y,i as h,b as I,j as z,g as t,w as n,l as x,f as w,c as P,h as $,ai as k,ao as B,aH as E,aI as S,z as j}from"./index-mJqsIMw-.js";const q={list:a=>b.post("other-ip/getIpInfo",a)},D=a=>(E("data-v-846f1f2b"),a=a(),S(),a),M={class:"flex-c"},U=D(()=>w("div",{class:"i-material-symbols-light:not-started-outline-rounded h-1.5em w-1.5em"},null,-1)),H=N({name:"queryIP",__name:"list",setup(a){const C=g(!1),s=g([]),r=g("");async function V(){try{if(s.value&&s.value.length===0)return k.warning({message:"请至少输入一个IP",center:!0});const c=s.value.split(`
