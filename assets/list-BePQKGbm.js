...
import{x as I,d as w,r as u,a as i,p as C,q as V,i as p,o as b,b as N,f as t,w as n,I as _,s as m,g as $,E as z,ao as P,aJ as E,aK as k,R as B}from"./index-VLp8k4vq.js";const S={list:s=>I.post("other-ip/getIpInfo",s)},q=s=>(E("data-v-6ac20251"),s=s(),k(),s),D={class:"flex-c"},M=q(()=>m("div",{class:"i-material-symbols-light:not-started-outline-rounded h-1.5em w-1.5em"},null,-1)),R=w({name:"queryIP",__name:"list",setup(s){const f=u(!1),a=u([]),r=u("");async function g(){try{if(a.value&&a.value.length===0)return z.warning({message:"请至少输入一个IP",center:!0});const c=a.value.split(`
