...
import{k as b,d as h,r as d,a as i,q as k,o as f,b as U,f as e,w as a,i as p,B as _,v as B,s as E,e as z,g as C,bq as D,E as g,ao as P,M as j}from"./index-DZ7Gqds7.js";const M={list:m=>b.post("callback/getAnalyzeUid",m)},N={class:"flex-c"},q=h({name:"uidParsing",__name:"index",setup(m){d(!1);const o=d(""),l=d([]),u=d("");async function v(){try{if(l.value&&l.value.length===0)return g.warning({message:"请至少输入一clickId",center:!0});if(!o.value)return g.warning({message:"请输入项目ID",center:!0});const c=l.value.split(`
