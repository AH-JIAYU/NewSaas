        ...
        <ElForm ref="formRef" :rules="rules" :model="props.leftTab" label-width="100px"
          ...
          <el-card class="box-card">
            ...
            <el-row :gutter="10">
              ...
              <el-col :span="8" v-if="props.leftTab.type !== 'company'">
                <el-form-item label="初始密码">
                  <el-input clearable value="123456" disabled style="width: 80%" />
                  <el-tooltip effect="dark" content="重置密码" placement="top-start" v-if="props.leftTab.tenantSupplierId">
                    <img src="@/assets/images/refresh.png" alt="" style="margin-left: 10px;cursor: pointer;"
                      @click="reFreshCode">
                  </el-tooltip>
