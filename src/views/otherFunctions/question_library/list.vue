...
defineOptions({
  name: 'OtherFunctionsQuestionLibrary List',
})
  ...
  <div :class="{ 'absolute-container': data.tableAutoHeight }">
    ...
    <PageMain>
      ...
      <ElTable v-loading="data.loading" class="my-4" :data="data.dataList" stripe highlight-current-row border height="100%" @sort-change="sortChange" @selection-change="data.batch.selectionDataList = $event">
        ...
        <ElTableColumn prop="option" label="选项" />
        <ElTableColumn prop="country" label="所属国家" />
        <ElTableColumn prop="name" label="创建人" />
        <ElTableColumn prop="time" label="创建时间" />
