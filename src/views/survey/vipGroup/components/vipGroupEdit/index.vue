...
import LeftTabs from '../vipGroupLeftTabs/index.vue'
...
<template>
  <div>
    <el-drawer
      v-model="drawerisible" :class="title === '添加' ? 'hide-drawer-header' : 'edit-drawer'" append-to-body :close-on-click-modal="false" destroy-on-close draggable size="55%"
      @close="close"
    >
