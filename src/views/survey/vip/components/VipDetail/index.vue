<script setup>
import VipDetailDetail from "../VipDetailDetail/index.vue";
...
<template>
  <el-drawer v-model="drawerisible" append-to-body :close-on-click-modal="false" destroy-on-close draggable size="55%"
