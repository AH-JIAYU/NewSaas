...
async function fetchData() {
  try {
    ...
    memberBackgroundUrl.value = res.data.memberBackgroundUrl ? import.meta.env.VITE_common_HTTP + res.data.memberBackgroundUrl :import.meta.env.VITE_common_WEBSITE
  } catch (error) {
