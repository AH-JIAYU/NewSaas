      ...
      >
        ...
        >
          <template #default="{ row }">
            <el-tag v-if="row.surveySource === 1" effect="dark" type="primary">
             {{ t("RecordsManagement.internalVip") }}
            </el-tag>
            <el-tag v-if="row.surveySource === 2" effect="dark" type="warning">
              {{ t("RecordsManagement.externalVip") }}
            </el-tag>
            <el-tag v-if="row.surveySource === 3" effect="dark" style="background-color: #aed500; border: none">
              {{ t("RecordsManagement.outsourcingVip") }}
            </el-tag>
        ...
        >
          <template #default="{ row }">
            ...
            <div v-if="row.surveySource === 1 || row.surveySource === 2">
              <div v-if="row.memberId" style="display: flex" class="oneLine2">
                <el-tag type="warning" class="tag-with-image" style="color: #a0c205; background: #f7ffd1">
                  <img
              ...
              <div v-if="row.tenantSupplierId" style="display: flex" class="oneLine2">
              ...
              <div v-if="row.surveySource === 1 && row.memberChildId" style="display: flex" class="oneLine2">
                <el-tag type="warning" class="tag-with-image" style="color: #a0c205; background: #f7ffd1">
                  <img
                    src="@/assets/images/huiyuan.png" style="
                      width: 0.9375rem;
    ...
    current: row.id === current,
        ...
        >
          <template #default="{ row }">
            <div class="fontC-System">
              <svg
                v-if="row.memberCurrencyType === 'USD'" xmlns="http://www.w3.org/2000/svg" width="7" height="12"
                viewBox="0 0 7 12" fill="none"
              >
                <path
                  id="Vector"
              ...
              <svg
                v-if="row.memberCurrencyType === 'CNY'" xmlns="http://www.w3.org/2000/svg" width="9" height="10"
                viewBox="0 0 9 10" fill="none"
              >
                <path
                  id="Vector"
  ...
  <el-tag effect="plain" type="info">
    {{ row.surveyTime ? `${row.surveyTime}min` : 0 }}/
        ...
        >
          <template #default="{ row }">
            <el-tag
              v-if="row.surveyStatus === 3" effect="dark" style="background-color: #fb6868; border: none"
              class="mx-1" type="primary"
            >
              配额满
            </el-tag>
            <el-tag
              v-if="row.surveyStatus === 1" effect="dark" style="background-color: #379aff; border: none"
              class="mx-1" type="success"
            >
              完成
            </el-tag>
            <el-tag
              v-if="row.surveyStatus === 2" effect="dark" style="background-color: #fb6868; border: none"
              class="mx-1" type="danger"
            >
              被甄别
            </el-tag>
            <el-tag
              v-if="row.surveyStatus === 4" effect="dark" style="background-color: #05c9be; border: none"
