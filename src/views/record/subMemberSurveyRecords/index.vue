...
import api from "@/api/modules/record_subMemberSurveyRecords";
...
const columns = ref([
  ...
  { prop: "memberChildId", label: "子会员Id", sortable: true, checked: true },
  { prop: "memberChildName", label: "所属组", sortable: true, checked: true },
  {
        ...
        <template #default="{ fold, toggle }">
          ...
          >
            ...
            <el-form-item v-show="!fold" label="">
              <!-- <el-select
                v-model="queryForm.memberChildGroupId"
                clearable
                placeholder="子会员组"
              /> -->
              <el-input
