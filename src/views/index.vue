      ...
      <PageMain class="ecology">
        <template #title>
          ...
          <div class="ms-auto">
            ...
            <HButton outline class="ms-2" @click="open('https://hooray.github.io/fantastic-startkit')">
              备用地址
            </HButton>
          </div>
        </template>
      ...
      <PageMain class="ecology">
        <template #title>
          ...
          <div class="ms-auto">
            ...
            <HButton outline class="ms-2" @click="open('https://fantastic-admin.github.io')">
              备用地址
            </HButton>
          </div>
        </template>
      ...
      <PageMain class="ecology">
        <template #title>
          ...
          <div class="ms-auto">
            ...
            <HButton outline class="ms-2" @click="open('https://one-step-admin.github.io')">
              备用地址
            </HButton>
          </div>
        </template>
