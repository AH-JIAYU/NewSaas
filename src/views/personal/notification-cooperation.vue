            ...
            <span style="color: #333;">
              <el-tooltip effect="dark" placement="top-start">
                <template #content>
                  ...
                  <div>代替邀约方公司名称货币类型为{{ tenantCurrencyType === 1 ? '美元' : '人民币' }}，与您的货币类型{{ tenantPartnersCurrencyType
        === 1 ? '美元' : '人民币' }}汇率换算为{{ tenantCurrencyType === tenantPartnersCurrencyType ? '1: 1' : '1: 100'}}，请您悉知。</div> -->
                </template>
          ...
          <el-row class="radiusInput" style="margin: 0;" :gutter="20">
            <el-col style="padding: 0;" :span="11">
              ...
              <el-input v-if="tenantPartnersCurrencyType === 2" style="border: none;" v-model="moneyDefault" disabled
                placeholder="">
                <template #prefix>
              ...
              <el-input v-if="tenantPartnersCurrencyType === 1" style="border: none;" v-model="moneyDefault" disabled
                placeholder="">
                <template #prefix>
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                    <g id="Frame">
            ...
            <el-col style="padding: 0;" :span="11">
              <el-input v-if="tenantCurrencyType === 1" style="border: none;" v-model="data.exchangeRate"
              ...
              <el-input v-if="tenantCurrencyType === 2" style="border: none;" v-model="data.exchangeRate"
                placeholder="请输入换算金额" clearable>
                <template #prefix>
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                    <g id="Frame">
