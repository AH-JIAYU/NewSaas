            ...
            <el-row :gutter="20">
              ...
              <el-col :span="24" v-if="form.personalizedDomainNameMember">
                <el-form-item label="租户会员后台域名" prop="">
                  <el-text class="mx-1">{{
                    form.personalizedDomainNameMember
                  }}</el-text>
                  <el-button
                    class="copy"
                    type="primary"
                    plain
                    size="small"
                    @click="copyToClipboard(form.personalizedDomainNameMember)"
                    >复制</el-button
                  >
                </el-form-item>
              </el-col>
              <el-col :span="24" v-if="form.personalizedDomainNameSupplier">
                <el-form-item label="租户供应商后台域名" prop="">
                  <el-text class="mx-1">{{
                    form.personalizedDomainNameSupplier
                  }}</el-text>
                  <el-button
                    class="copy"
                    type="primary"
              ...
              <el-col :span="24" v-if="form.personalizedDomainNameTenant">
                <el-form-item label="租户后台域名" prop="">
                  <el-text class="mx-1">{{
                    form.personalizedDomainNameTenant
                  }}</el-text>
                  <el-button
                    class="copy"
                    type="primary"
                    plain
                    size="small"
                    @click="copyToClipboard(form.personalizedDomainNameTenant)"
                    >复制</el-button
                  >
                </el-form-item>
              </el-col>
