...
<template>
  <ElForm label-width="100px" :rules="rules" ref="formRef" :model="props.leftTab">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="6">
              ...
              <el-form-item label="所属客户" prop="clientId">
                <el-select placeholder="Select" v-model="props.leftTab.clientId" clearable>
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="6">
              <el-form-item style="width:200px">
                ...
                <el-input-number style="height: 2rem" v-model="props.leftTab.minimumDuration" :min="1" :step="1"
                  step-strictly controls-position="right" size="large" @keydown="handleInput" />

              </el-form-item>
              <el-tooltip class="tooltips" content="这份问卷必须要做到多少分钟" placement="top">
                      <SvgIcon name="i-ri:question-line" class="ms-4" />
                    </el-tooltip>
            </el-col>
            <el-col :span="6">
              <el-form-item label="IR">
                <el-input-number style="height: 2rem" v-model="props.leftTab.ir" :min="1" :precision="1" :step="0.1"
                  :max="100" controls-position="right" size="large"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="20">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="3">
              <el-form-item label="在线">
                <el-switch :active-value="1" :inactive-value="2" v-model="props.leftTab.isOnline" />
              </el-form-item>
            </el-col>
            <el-col :span="4">
