...
<template>
  <div>
    <el-drawer
      v-model="dialogTableVisible" :class="title === '添加' ? 'hide-drawer-header' : 'edit-drawer'"
      append-to-body :close-on-click-modal="false" destroy-on-close draggable size="70%" title="" @close="closeHandler"
    >
