       ...
       <!-- <el-form ref="formRef" label-width="130px" style="position: relative" :model="data.form" :rules="rules"
        ...
        <el-form-item label="指定类型" prop="dispatchType" style="align-items: center">
          <div style=" margin-bottom: 0px">
            <el-button style="margin-right: 4px;" :type="sendProjectType === 1 ? 'primary' : ''" size="small"
              @click="changeSendProjectType('指定关闭', 1)">指定关闭
            </el-button>
            <el-tooltip class="tooltips" content="选中供应商或部门，该供应商或部门无法参与该项目" placement="top">
              <SvgIcon class="SvgIcon1" name="i-ri:question-line" />
            </el-tooltip>
            <el-button style="margin-left: 1.5rem;margin-right: 4px;" :type="sendProjectType === 2 ? 'primary' : ''"
              size="small" @click="changeSendProjectType('指定价格', 2)">指定价格</el-button>
            <el-tooltip class="tooltips" content="举例:(选中供应商为：A供应商；指定价格为：100美元)则，A供应商下参与该项目的会员价格为100美元，无需通过会员等级进行计算"
              placement="top">
              <SvgIcon class="SvgIcon1" name="i-ri:question-line" />
            </el-tooltip>
          </div>
        ...
        <el-form-item label="项目ID/名称" prop="projectId" v-if="data.title === '新增'">
          <el-select placeholder="" v-model="data.form.projectId" clearable disabled filterable @change="changeProject">
