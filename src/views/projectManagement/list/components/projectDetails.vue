    ...
    >
      ...
      <template #header>
        <el-row :gutter="20">
          <el-col :span="2" />
          <el-col :span="20">
            <el-steps style="max-width: 100%;" :active="1" finish-status="success" simple>
              <el-step title="已开始" />
              <el-step title="已确认" />
              <el-step title="已开票" />
              <el-step title="已完结" />
      ...
      <ElForm label-width="100px" model="" rules="rules">
        <el-card class="box-card">
          ...
          <el-row :gutter="10">
            <el-col :span="8">
              <el-form-item label="原价(美元)" prop="client" style="float: left; width: 20rem;">
                <el-input clearable />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="原价(人民币)" prop="name" style="float: left; width: 20rem;">
                <el-input clearable />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="配额" prop="name" style="float: left; width: 20rem;">
                <el-input clearable />
              </el-form-item>
            </el-col>
            <el-col :span="8" />
          ...
          <el-row :gutter="10">
            <el-col :span="8">
              <el-form-item label="限量/h" prop="client" style="float: left; width: 20rem;">
                <el-input clearable />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="准入量" prop="name" style="float: left; width: 20rem;">
                <el-input clearable />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="IR" prop="name" style="float: left; width: 20rem;">
                <el-input clearable />
              </el-form-item>
            </el-col>
            <el-col :span="8" />
          ...
          <el-row :gutter="10">
            <el-col :span="8">
              <el-form-item label="最小时长" prop="client" style="float: left; width: 20rem;">
                <el-input clearable />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="互斥ID" prop="name" style="float: left; width: 20rem;">
                <el-input clearable />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="URL" prop="name" style="float: left; width: 20rem;">
                <el-input clearable />
              </el-form-item>
            </el-col>
            <el-col :span="8" />
          ...
          <el-row :gutter="10">
            <el-col :span="8">
              <el-form-item label="置顶" prop="client" style="float: left; width: 20rem;">
                <el-switch />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="资料" prop="name" style="float: left; width: 20rem;">
                <el-input clearable />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="B2B" prop="name" style="float: left; width: 20rem;">
                <el-input clearable />
              </el-form-item>
            </el-col>
            <el-col :span="8" />
          ...
          <el-row :gutter="10">
            <el-col :span="8">
              <el-form-item label="信用" prop="client" style="float: left; width: 20rem;">
                <el-input clearable />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="定时发布" prop="name" style="float: left; width: 20rem;">
                <el-input clearable />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="备注" prop="name" style="float: left; width: 20rem;">
                <el-input clearable />
              </el-form-item>
            </el-col>
            <el-col :span="8" />
          ...
          <el-row :gutter="10">
            <el-col :span="8">
              <el-form-item label="终端" prop="client" style="float: left; width: 20rem;">
                <el-input clearable />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="性别" prop="name" style="float: left; width: 20rem;">
                <el-input clearable />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="年龄" prop="name" style="float: left; width: 20rem;">
                <el-input clearable />
              </el-form-item>
            </el-col>
            <el-col :span="8" />
