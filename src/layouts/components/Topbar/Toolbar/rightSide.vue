    ...
    <el-dropdown>
      ...
      <template #dropdown>
        <el-dropdown-menu class="drop-item">
          <div class="item-1">
            <div class="flex-item gap-1" style="padding: .625rem 0;">
              <img v-if="userStore.avatar && !avatarError" :src="userStore.avatar" :onerror="() => (avatarError = true)"
            ...
            <div class="member-set">
              <div style="border-bottom: 1px solid rgba(139, 160, 191, 0.3)" class="padding-8">
                <div style="margin-top: 5px;">
                  <img src="@/assets/images/member.png" />
                  <span class="color2 font-w" style="margin-left: 0.5rem">试用版</span>
                </div>
                <div class="font-w font-s14 margin-t8">到期时间：<span style="color: #8795ae;font-weight: 400;">{{ userStore.expirationTime ?
              userStore.expirationTime.substring(0, 10) : '-' }}</span></div>
              </div>
          ...
          <div class="item-2 padding-8 ">
            <div class=" padding-t16 flex-item " @click="getPerson">
              <img src="@/assets/images/user.png" style="width: 1.25rem;height: 1.25rem;margin-left: 0.5rem;" />
              <span style="margin-left: 0.5rem" class="color1 hover-item">个人中心</span>
            </div>
            <div class=" padding-t16  flex-item " @click="getNotice">
              <img src="@/assets/images/notice.png" style="width: 1.25rem;height: 1.25rem;margin-left: 0.5rem;" />
              <span style="margin-left: 0.5rem" class="color1 hover-item"> 通知中心</span>
            </div>
            <div class=" padding-t16  flex-item " @click="getSite">
              <img src="@/assets/images/position.png" style="width: 1.25rem;height: 1.25rem;margin-left: 0.5rem;" />
            ...
            <div class=" padding-t16  flex-item padding-b16" @click="getTenantry">
              <img src="@/assets/images/tenant.png" style="width: 1.25rem;height: 1.25rem;margin-left: 0.5rem;" />
              <span style="margin-left: 0.5rem" class="color1 hover-item"> 合作租户</span>
            </div>
          </div>
          <div class="item-3 padding-8 " style="border-top: 1px solid rgba(139, 160, 191, 0.3)" @click="logout">
            <div class=" flex-item padding-t4" style="padding:1rem 0 0.5rem 0;">
              <img src="@/assets/images/lognOut.png" style="width: 1.25rem;height: 1.25rem;margin-left: 0.5rem;" />
