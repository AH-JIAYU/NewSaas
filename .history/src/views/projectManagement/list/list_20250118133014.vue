    ...
    <PageMain class="hide-drawer-header">
      ...
      <el-row :gutter="24">
        <FormLeftPanel>
          ...
          <el-checkbox
            v-model="checked1" style="margin-left: 12px" label="查询本部门项目列表" size="large"
            @change="handleChange"
          />
        </FormLeftPanel>
        <FormRightPanel>
      ...
      >
        ...
        >
          <template #default="{ row }">
            <ElSwitch
              v-model="row.isOnline" inline-prompt active-text="在线" inactive-text="离线"
              :active-value="1" :inactive-value="2" @change="changeStatus(row, $event)"
            />
          </template>
        </el-table-column>
        <el-table-column v-if="checkList.includes('projectId')" align="left" label="项目" width="180">
          <template #default="{ row }">
            <p>
              <span class="tableBig">
        ...
        <el-table-column
          v-if="checkList.includes('name')" show-overflow-tooltip prop="name" align="left" label="名称/别名"
          width="200"
        >
          <template #default="{ row }">
            <div class="flex-c">
        ...
        <el-table-column v-if="checkList.includes('PCNL')" align="left" label="统计" width="200">
          <template #default="{ row }">
            <div class="flex-c">
        ...
        <el-table-column
          v-if="checkList.includes('doMoneyPrice')" show-overflow-tooltip align="left" label="单价"
          width="110"
        >
          <template #default="{ row }">
            <div class="flex-c">
        ...
        <el-table-column
          v-if="checkList.includes('create')" prop="createTime" align="left" width="120" label="创建"
          show-overflow-tooltip
        >
          <template #default="{ row }">
            <div>
