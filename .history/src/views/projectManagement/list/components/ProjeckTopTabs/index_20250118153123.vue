            ...
            <el-col :span="5">
              <el-form-item :label="t('newProject.sex')" class="flex" prop="sex">
                <el-radio-group
                  ...
                  :disabled="localToptTab.projectType === 2"
                >
                  <el-radio-button :value="1" :label="t('newProject.sex')"></el-radio-button>
                  <el-radio-button :value="2" :label="t('newProject.sex')"></el-radio-button>
                  <el-radio-button :value="3" :label="t('newProject.sex')"></el-radio-button>
                </el-radio-group>
              </el-form-item>
            </el-col>
            <el-col :span="4">
