  ...
  <div>
    <ElForm ref="formRef" :rules="rules" :model="localToptTab" label-width="110px">
      <el-tabs v-model="activeName">
        ...
        <el-tab-pane :label="t('newCustomer.portSetting')" name="portSettings">
          <el-card class="box-card">
            <template #header>
              <div class="card-header">
      ...
      " />
              ...
              <el-col :span="24">
                <el-form-item :label="t('newCustomer.successfulRedirect')">
                  {{ redirectUrl }}
                  <span>
              ...
              <el-col :span="24">
                <el-form-item :label="t('newCustomer.fullRedirect')">
                  {{ redirectUrl }}
                  <span>
              ...
              <el-col :span="24">
                <el-form-item :label="t('newCustomer.beDcreenedRedirects')">
                  {{ redirectUrl }}
                  <span>
              ...
              <el-col :span="24">
                <el-form-item :label="t('newCustomer.securityRedirection')">
                  {{ redirectUrl }}
                  <span>
      ...
      " :active-value="1" :inactive-value="2" inline-prompt :active-text="t('newCustomer.encipher')" :inactive-text="t('newCustomer.encipher')" />
                </el-form-item>
              </el-col>
