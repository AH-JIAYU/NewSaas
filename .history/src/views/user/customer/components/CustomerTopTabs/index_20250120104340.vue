        ...
        <el-tab-pane label="基础设置" name="basicSettings">
          <el-card class="box-card">
            ...
            <el-row :gutter="24">
              ...
              <el-col :span="12">
                <el-form-item :label="t('newCustomer.companyName')" prop="customerName">
                  <el-input v-model="localToptTab.customerName" clearable />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item :label="t('newCustomer.companyName')" prop="customerPhone">
                  <el-input v-model="localToptTab.customerPhone" clearable />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item :label="t('newCustomer.companyName')" prop="emailAddress">
                  <el-input v-model="localToptTab.emailAddress" clearable />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item :label="t('newCustomer.companyName')" prop="chargeId">
              ...
              <el-col :span="12">
                <el-form-item :label="t('newCustomer.companyName')" prop="settlementCycle">
