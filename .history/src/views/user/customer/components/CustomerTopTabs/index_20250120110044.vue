            ...
            <el-row :gutter="24">
              <el-col :span="4">
                <el-form-item :label="t('newCustomer.customerStatus')">
                  ...
                  :active-text="t('newCustomer.on')" :inactive-text="t('newCustomer.ogg')" />
                </el-form-item>
              </el-col>
              <el-col :span="4">
                <el-form-item :label="t('newCustomer.preQuestionnaire')">
                  <el-switch v-model="localToptTab.antecedentQuestionnaire" :active-value="2" :inactive-value="1"
                    inline-prompt :active-text="t('newCustomer.on')" inactive-text="关闭" />
                </el-form-item>
              </el-col>
              <el-col :span="16">
                <el-form-item :label="t('newCustomer.riskControl')">
                  ...
                  :active-text="t('newCustomer.on')" inactive-text="关闭" />
                </el-form-item>
              </el-col>
